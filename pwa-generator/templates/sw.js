const CACHE_NAME = '{{ cache_name }}-{{ cache_version|default("1") }}';
const API_CACHE_NAME = '{{ cache_name }}-{{ cache_version|default("1") }}-api';
const urlsToCache = [
  './',
  'client-styles.css?v={{ cache_version|default("1") }}',
  'client-app.js?v={{ cache_version|default("1") }}',
  'manifest.json',
